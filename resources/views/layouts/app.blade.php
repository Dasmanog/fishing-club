...
<body style="background-image: url('{{ asset('/img/background.jpg')}}');">
    <div id="app">
        <nav class=" image navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
...
<!-- kad rodytu pranesimus kai atliekam korekcija, keliam cia ir keliam i kontrolerius -->
        <div class="container">
